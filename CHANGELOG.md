...
## [0.1.62](https://github.com/halojerry/poundingcore/compare/v0.1.61...v0.1.62) (2026-08-06)


### Features

* **acp:** backport config-options endpoint with POUNDING ActiveAgentNotFound handling ([1ee1378](https://github.com/halojerry/poundingcore/commit/1ee1378d54f15d3dca6ed00a078da8a16d65f6b6))
* **acp:** dead ACP connection recovery — phase tracking + guards + eviction ([887c225](https://github.com/halojerry/poundingcore/commit/887c225125a18759040b4ce245f142a7bc6cc945))
* **acp:** inject OPENCODE_CONFIG for OpenCode, OPENCLAW env vars for OpenClaw ([4d88d26](https://github.com/halojerry/poundingcore/commit/4d88d26d86a593b13a9f7e12291fd0d9d5a31406))
* **acp:** use observed config options for preferences ([#468](https://github.com/halojerry/poundingcore/issues/468)) ([fd2d5c2](https://github.com/halojerry/poundingcore/commit/fd2d5c2db10e80dc478ee88c2d1f787e91015eb1))
* add 3 new builtin assistants (teacher, getnote, xiaohongshu-creator) ([28e535a](https://github.com/halojerry/poundingcore/commit/28e535a2517c79c8c29fc8c94d9e4d968ee26312))
* add GET/PUT /api/settings/managed-runtime endpoint ([9e5d1a4](https://github.com/halojerry/poundingcore/commit/9e5d1a45b9e4ce6e395537f35d1decb19a8fc3cb))
* add pounding serde alias for ConversationSource ([9a41a59](https://github.com/halojerry/poundingcore/commit/9a41a591395cd794500d189c0ea4ca5e57dbcdcf))
* **agent:** add Antigravity (agy CLI) as a direct-CLI agent ([#741](https://github.com/halojerry/poundingcore/issues/741)) ([ddfd76b](https://github.com/halojerry/poundingcore/commit/ddfd76b9aa0e1192d02918f79490f1c4d06d343e))
* **agent:** detect availability via session/new probe and assistant-first identity ([#500](https://github.com/halojerry/poundingcore/issues/500)) ([6c9a721](https://github.com/halojerry/poundingcore/commit/6c9a721fc4cf2b712f5c7b974f51b2935a0293b7))
* **agent:** multimodal prompt — native image/audio content blocks gated by promptCapabilities ([#774](https://github.com/halojerry/poundingcore/issues/774)) ([5a78a0b](https://github.com/halojerry/poundingcore/commit/5a78a0b2722edcce9f979d3f06c4461577f9e574))
* **agents:** add MiMo Code builtin ACP agent ([#700](https://github.com/halojerry/poundingcore/issues/700)) ([3a2d7e4](https://github.com/halojerry/poundingcore/commit/3a2d7e48386fd608b752354f032657c442b13e1b))
* **agents:** add omp (Oh My Pi) builtin ACP agent ([#717](https://github.com/halojerry/poundingcore/issues/717)) ([91f375d](https://github.com/halojerry/poundingcore/commit/91f375db0ba355c011309484382f4d5ab90ccbb2))
* **agents:** add Pi coding agent as builtin ACP agent ([#618](https://github.com/halojerry/poundingcore/issues/618)) ([0b9b3a8](https://github.com/halojerry/poundingcore/commit/0b9b3a882712f555e60fd33c027b604471df25c7))
* **agents:** sync ACP Registry integrations ([#637](https://github.com/halojerry/poundingcore/issues/637)) ([7d35e38](https://github.com/halojerry/poundingcore/commit/7d35e386969bb2dca58ca332adf00f9ae5bed6ce))
* **agent:** use aionrs runtime env API ([#586](https://github.com/halojerry/poundingcore/issues/586)) ([2f6f43f](https://github.com/halojerry/poundingcore/commit/2f6f43f305221701ca2baa58123180caf2342055))
* **ai-agent:** adapt to aionrs v0.2.2 config changes ([4f71bf2](https://github.com/halojerry/poundingcore/commit/4f71bf2c97de1bafc676906e26a5cf512ff94af9))
* **ai-agent:** route image attachments by model capability ([82c5bc1](https://github.com/halojerry/poundingcore/commit/82c5bc14bcb1fcf4396e033764732adbe63966ef))
* **ai-agent:** surface upstream 429 body in AgentSendError detail ([#591](https://github.com/halojerry/poundingcore/issues/591)) ([b8fe5b6](https://github.com/halojerry/poundingcore/commit/b8fe5b6f3c6f93f7b8fc730b658772da3f4f83fa))
* **ai-agent:** use responses api for gpt-5.6 ([cde4129](https://github.com/halojerry/poundingcore/commit/cde4129521340fe71e67a40f17f0d00a2935fe2a))
* **ai-agent:** use responses api for gpt-5.6 ([15bbb1e](https://github.com/halojerry/poundingcore/commit/15bbb1eeb97fa619bea14733958fc9623100a274))
* **aionrs:** consume attached files as structured content blocks ([0f8c7d1](https://github.com/halojerry/poundingcore/commit/0f8c7d1b681d35fdf55b857948978fc28444bf61))
* **aionrs:** inline image attachments for Aion CLI ([aff870b](https://github.com/halojerry/poundingcore/commit/aff870bb1d3328abfc3d0c24d8898f0e148790ab))
* **aionrs:** inline image attachments for Aion CLI ([e4e5e9b](https://github.com/halojerry/poundingcore/commit/e4e5e9b26867b59f8c66a11b1fc80abc0029b651))
* align team shared workspace resolution ([#475](https://github.com/halojerry/poundingcore/issues/475)) ([06b8e71](https://github.com/halojerry/poundingcore/commit/06b8e71572045ddac640bda38e2733dd9ad35f18))
* **assets:** update Kimi logo to official brand mark ([#646](https://github.com/halojerry/poundingcore/issues/646)) ([1c41b50](https://github.com/halojerry/poundingcore/commit/1c41b50d93b5cdb188792d9c6e794fb0e0a950a0))
* **assistant:** add built-in AionUi self-management assistant ([#474](https://github.com/halojerry/poundingcore/issues/474)) ([eea941e](https://github.com/halojerry/poundingcore/commit/eea941e344b9dd11338393078c63bddcc532137e))
* **assistant:** expand AionUi assistant into a butler with remote-access ([#481](https://github.com/halojerry/poundingcore/issues/481)) ([794c21a](https://github.com/halojerry/poundingcore/commit/794c21a589ef24de6f3fa03a628bb47e7958d6fe))
* **assistant:** persist thought-level defaults ([#574](https://github.com/halojerry/poundingcore/issues/574)) ([dd9f299](https://github.com/halojerry/poundingcore/commit/dd9f29967270f4e7263484532fad3b2199ba1894))
* **assistant:** 官方助手默认关闭 + 固定顺序 + 一次性重置迁移 ([#567](https://github.com/halojerry/poundingcore/issues/567)) ([3e30b02](https://github.com/halojerry/poundingcore/commit/3e30b02e021642ea116b68abc441bca0b91c60f3))
* **auth:** add NewApi login endpoint for WebUI ([e4aa3d7](https://github.com/halojerry/poundingcore/commit/e4aa3d7dc933441bfdb6578d3bf265623d10d9fa))
* bind pounding-ozon-probe skill to ozon assistant ([#4](https://github.com/halojerry/poundingcore/issues/4)) ([3e55a1e](https://github.com/halojerry/poundingcore/commit/3e55a1ee8e3f06a52d80322a97e8fdc786efc297))
* cc-switch unified 5-CLI config + model switch fix + ozon skill updates ([2739f94](https://github.com/halojerry/poundingcore/commit/2739f948cba8802f25445422e02a473b8234c658))
* **ci:** bundle managed CLI resources (node,acp,native) in release ([dddc8f8](https://github.com/halojerry/poundingcore/commit/dddc8f8a12cc1a33304f7aed5b3f2f744af946b5))
* **cli:** add agent-facing config and diagnose commands ([#595](https://github.com/halojerry/poundingcore/issues/595)) ([e80177e](https://github.com/halojerry/poundingcore/commit/e80177e95a380c89f833b4302ff24b7359ac2a58))
* **cli:** canonicalize CLI and bootstrap boundary errors ([#417](https://github.com/halojerry/poundingcore/issues/417)) ([9ddf82e](https://github.com/halojerry/poundingcore/commit/9ddf82e374f9f40fa5f7321fea54dca3a611f3c5))
* **config:** add conversation rename command ([#638](https://github.com/halojerry/poundingcore/issues/638)) ([a611553](https://github.com/halojerry/poundingcore/commit/a61155379ac031a161b210d4bdc297d009ba5a11))
* converge team mode runtime architecture ([#464](https://github.com/halojerry/poundingcore/issues/464)) ([abeb9a1](https://github.com/halojerry/poundingcore/commit/abeb9a184a280a8da1f9089a90f7be2db3c94af4))
* **conversation:** add cursor pagination for messages ([#515](https://github.com/halojerry/poundingcore/issues/515)) ([ba76273](https://github.com/halojerry/poundingcore/commit/ba7627328ae8447afb7566e90cbb556fa381dff0))
* **conversation:** agent-driven session auto-naming (ACP session_info_update + claude generate_session_title) ([#768](https://github.com/halojerry/poundingcore/issues/768)) ([c551c66](https://github.com/halojerry/poundingcore/commit/c551c6614270ba6bf045627a1598e71bbf77d63d))
* **conversation:** fork a conversation into a new one at a chosen message ([#772](https://github.com/halojerry/poundingcore/issues/772)) ([bb7c14e](https://github.com/halojerry/poundingcore/commit/bb7c14ef26f5af1157946841d12c5027c486cc21))
* **cron:** deduplicate and protect scheduled executions ([#601](https://github.com/halojerry/poundingcore/issues/601)) ([b189de0](https://github.com/halojerry/poundingcore/commit/b189de0e0a5a3cb837de8b0237ce6e7f96c8aa3d))
* **diagnostics:** expand feedback runtime evidence ([#612](https://github.com/halojerry/poundingcore/issues/612)) ([08426dc](https://github.com/halojerry/poundingcore/commit/08426dcf83290577a2b8ef706bc3c1d21354425c))
* enforce agent runtime policy and turn-aware state ([#436](https://github.com/halojerry/poundingcore/issues/436)) ([b7099fe](https://github.com/halojerry/poundingcore/commit/b7099fee0cd2488326957dfe7811bf87e15aabb7))
* enforce TeamRun ownership for agent turns ([#483](https://github.com/halojerry/poundingcore/issues/483)) ([4cc168a](https://github.com/halojerry/poundingcore/commit/4cc168a57c07879310d9e4fe8b8050735f35155a))
* **fs:** add /api/fs/reveal endpoint (resolve pe-ref + show in folder) ([#754](https://github.com/halojerry/poundingcore/issues/754)) ([f6977c7](https://github.com/halojerry/poundingcore/commit/f6977c784a7b508a5fc75f4c79977fd43ce22b4e))
* **fs:** add ChatFileRef content endpoints ([#757](https://github.com/halojerry/poundingcore/issues/757)) ([e8b6f4c](https://github.com/halojerry/poundingcore/commit/e8b6f4c825e04bc2c454ac75005d6f7f7642926d))
* **fs:** pdf stream endpoint + office ChatFileRef resolve + retire fs/resolve & WS fs/read ([#762](https://github.com/halojerry/poundingcore/issues/762)) ([e4e991a](https://github.com/halojerry/poundingcore/commit/e4e991afed637346e57578a3da48b6a3c62ce960))
* **idle:** extend idle-cleanup timeouts and make them env-configurable ([#643](https://github.com/halojerry/poundingcore/issues/643)) ([a719bc7](https://github.com/halojerry/poundingcore/commit/a719bc74a5587097246689c683079488fba73007))
* inject builtin MCP servers (chrome-devtools + image-gen) into agent sessions ([fcc56ab](https://github.com/halojerry/poundingcore/commit/fcc56ab7b1ff94db18b95f31e04a74979b1b4431))
* integrate 45 builtin assistants + 170 skills + 47 avatars + 156 rules ([7072069](https://github.com/halojerry/poundingcore/commit/7072069bf86a6616e3dc5eb4b15e811420724be9))
* **lark:** add Lark/Feishu builtin assistant with 27 skills ([a47a2a4](https://github.com/halojerry/poundingcore/commit/a47a2a452fc426f6b302b483382ce4c164061f7c))
* **mcp:** add Chrome DevTools as builtin MCP server for all agents ([e9462c1](https://github.com/halojerry/poundingcore/commit/e9462c122828ad8dfc7b3bc6401cab808137c1e4))
* **mcp:** wire Image Generation MCP into ACP sessions ([dff9c2a](https://github.com/halojerry/poundingcore/commit/dff9c2a2cd7d622014d35ec66691f834d03db65e))
* multi-account user scope isolation ([#669](https://github.com/halojerry/poundingcore/issues/669)) ([7f8ed6c](https://github.com/halojerry/poundingcore/commit/7f8ed6c5d5a899984e23b1ae130640bdeaffd6dc))
* **ozon:** bump skill to v0.7.0 — add search, probe, fix-prices commands ([a3df382](https://github.com/halojerry/poundingcore/commit/a3df382e1268fdd773b84fc1b928482cf3972b2c))
* POUNDING brand shell on clean upstream baseline (v0.1.61) ([ae28174](https://github.com/halojerry/poundingcore/commit/ae2817447c26be7073f3baf4e892a8dbf5aa517b))
* POUNDING brand shell on clean upstream baseline (v0.1.61) ([ecd8088](https://github.com/halojerry/poundingcore/commit/ecd80888570db834c01274ec83dab104dfcb699f))
* **project:** add project-bind foundation (db + aionui-project) ([#672](https://github.com/halojerry/poundingcore/issues/672)) ([70eae04](https://github.com/halojerry/poundingcore/commit/70eae0465259c4a4ca1db44a1a456b0040d1d24f))
* **project:** add project-bind foundation (renumber migration 028→031) ([6002a53](https://github.com/halojerry/poundingcore/commit/6002a53ef28f5536ed5172cb34ffbdc843cd8c27))
* **project:** fs/search filename search vertical ([#720](https://github.com/halojerry/poundingcore/issues/720)) ([b64ab4f](https://github.com/halojerry/poundingcore/commit/b64ab4fd6eef74812360d2a901aa39d8c946c033))
* **project:** hide OS-junk and VCS-internal noise from listings ([#727](https://github.com/halojerry/poundingcore/issues/727)) ([6197117](https://github.com/halojerry/poundingcore/commit/6197117ef09bc0797f5656d3d6c3ec2e40161c09))
* **project:** Project Explorer backend (runtime, WS monitor, HTTP) ([#701](https://github.com/halojerry/poundingcore/issues/701)) ([0a79100](https://github.com/halojerry/poundingcore/commit/0a791002b0b43f0ac883a4b58b76336830041da0))
* **project:** wire project-bind side branch into owner creation ([#676](https://github.com/halojerry/poundingcore/issues/676)) ([300c833](https://github.com/halojerry/poundingcore/commit/300c8339af25807913eec921b0221cf51e1db145))
* **provider:** add per-model capability settings ([0f60d7e](https://github.com/halojerry/poundingcore/commit/0f60d7edda96f3a3a43d27765a8e800f53c6d294))
* **provider:** add per-model capability settings ([ba3e9ff](https://github.com/halojerry/poundingcore/commit/ba3e9ff1a893bf7111173b8e9301a0c2f140a2c1))
* register pounding-expert and social-cover-design builtin assistants ([c17bc8e](https://github.com/halojerry/poundingcore/commit/c17bc8e784c1dd37bc4e0efc3d8b9d1638535ea6))
* remove single-chat team upgrade path ([#524](https://github.com/halojerry/poundingcore/issues/524)) ([5c60df3](https://github.com/halojerry/poundingcore/commit/5c60df38473b5a566e4f3598f6a36dfb63f52bab))
* **scripts:** carry aionrs changelog into the bump PR ([#703](https://github.com/halojerry/poundingcore/issues/703)) ([f34cfb6](https://github.com/halojerry/poundingcore/commit/f34cfb61ba58266dfe8100cebc678925c9d67806))
* **session-port:** route claude/codex through SessionAgentTask (cc_switch preserved, branding intact) ([b7cd4c1](https://github.com/halojerry/poundingcore/commit/b7cd4c1a521fc2e52f296a0dfd0661c82aa2a5b6))
* **session-port:** route claude/codex through the direct-CLI SessionAgentTask ([#609](https://github.com/halojerry/poundingcore/issues/609)) ([14efff8](https://github.com/halojerry/poundingcore/commit/14efff85f192e0d1a588584fea3a870347661de7))
* **session:** make background work visible — live progress cards and out-of-turn delivery ([#758](https://github.com/halojerry/poundingcore/issues/758)) ([f0422ca](https://github.com/halojerry/poundingcore/commit/f0422ca28b08b3e16e8e8e2dd1778e816694095e))
* **skill:** ozon-probe 升级到 v0.20.0 ([9cea5d8](https://github.com/halojerry/poundingcore/commit/9cea5d8cd5c976dcbbdc6227a8ca3f186e815a6a))
* **skill:** ozon-probe 升级到 v0.20.0（cloud_probe 扩展 + bootstrap_update 旧包迁移） ([c8d1ad1](https://github.com/halojerry/poundingcore/commit/c8d1ad129eb5679109a36cfacb503fb1fcad0ee6))
* slim CLI detection from 40 agents to 4 (claude, hermes, openclaw, aionrs); disable unsupported via migration 032; remove codex/opencode from cc-switch, factory, native CLI, managed CLI ([302ce0d](https://github.com/halojerry/poundingcore/commit/302ce0d860eedf54f00ca5b579e1c7c3eaffb6d0))
* **stt:** streaming transcription proxy over websocket ([#455](https://github.com/halojerry/poundingcore/issues/455)) ([1c19a8b](https://github.com/halojerry/poundingcore/commit/1c19a8b9a80be665d30310071c0c12bc95881c11))
* **system:** add feedback diagnostics report ([#585](https://github.com/halojerry/poundingcore/issues/585)) ([a3eb1e4](https://github.com/halojerry/poundingcore/commit/a3eb1e49396e715ce8464700dca5e50a966552ee))
* **team:** add CLI fallback collaboration transport ([#629](https://github.com/halojerry/poundingcore/issues/629)) ([bbb6fec](https://github.com/halojerry/poundingcore/commit/bbb6fec08f7fd818375664bc5bf206805013f7d0))
* **team:** add read-only mailbox/task activity API and real-time events ([#740](https://github.com/halojerry/poundingcore/issues/740)) ([f86c053](https://github.com/halojerry/poundingcore/commit/f86c053eded3e04f5139dadeb3bdb9bae94c9c3b))
* **team:** add run state snapshot endpoint ([#549](https://github.com/halojerry/poundingcore/issues/549)) ([2c7cfe8](https://github.com/halojerry/poundingcore/commit/2c7cfe8a3eb49c8be790a7733ccad2f8a49f19bd))
* **team:** centralize team MCP prompt governance ([#490](https://github.com/halojerry/poundingcore/issues/490)) ([5485a95](https://github.com/halojerry/poundingcore/commit/5485a95897c327dc2c8f4f1c44cfab7c6f628905))
* **team:** leader-only warmup with lazy teammate wakeup and per-member attach ([#670](https://github.com/halojerry/poundingcore/issues/670)) ([f75fca3](https://github.com/halojerry/poundingcore/commit/f75fca352e17fb722f04c647941f44e450b88426))
* **team:** leader-only warmup with lazy teammate wakeup and per-member attach ([#670](https://github.com/halojerry/poundingcore/issues/670)) ([f542da8](https://github.com/halojerry/poundingcore/commit/f542da83bf7387dc8525df561eda9f43f2c5ac34))
* **team:** support queued team_send_message semantics ([#479](https://github.com/halojerry/poundingcore/issues/479)) ([a57a079](https://github.com/halojerry/poundingcore/commit/a57a079136cbe8a5fafa0ff4d8660bbfa28a07c5))
* **team:** support slot-scoped team pause and wake flow ([#472](https://github.com/halojerry/poundingcore/issues/472)) ([398b20f](https://github.com/halojerry/poundingcore/commit/398b20f2279fc7b042ae65cbbe5658be953e6f31))
* 内置 MCP 服务默认注入 agent 会话(chrome-devtools + image-gen) ([0cd4225](https://github.com/halojerry/poundingcore/commit/0cd422585798d044f48a97a7aebc18f4dc07d4b4))


### Bug Fixes

* **A1:** return actual config_options from session aggregate on mode/model switch ([c979d46](https://github.com/halojerry/poundingcore/commit/c979d464eccd2b8ca536c960635115e161a9cc1f))
* **A2:** pass image-gen MCP script path as args to node ([32dac59](https://github.com/halojerry/poundingcore/commit/32dac596c594a332e17a786a3a3a0e9d450483e2))
* **A3:** generate manifest.json for bundled CLI resources ([7f7d2d6](https://github.com/halojerry/poundingcore/commit/7f7d2d6385f17b365dd62b797de3431485a533f9))
* **A9:** load DB builtin MCP servers when enabled ([06d37db](https://github.com/halojerry/poundingcore/commit/06d37db46ea363c690e7ffec8037f6546b492fc5))
* AC-1 + AC-2 — shutdown grace period + non-fatal persistence ([114b384](https://github.com/halojerry/poundingcore/commit/114b3843925e6941d9a29901288d7db21d0b9dd7))
* **acp:** add warning logs when OpenClaw config/token cannot be read ([f947996](https://github.com/halojerry/poundingcore/commit/f947996c0df7f5ce2e5c70d36ecfffeee191923f))
* **acp:** bound config RPC timeout and release lease without tearing down connection ([#654](https://github.com/halojerry/poundingcore/issues/654)) ([c9a0051](https://github.com/halojerry/poundingcore/commit/c9a005163df4dfef48bdbdd01f67be04cae120dd))
* **acp:** config_not_observed fix + MCP diagnostics + cargo fmt ([#19](https://github.com/halojerry/poundingcore/issues/19)) ([76ada73](https://github.com/halojerry/poundingcore/commit/76ada73421486a02b0d42bbcb93537c11d69cd07))
* **acp:** confirm legacy mode/model on ACK instead of awaiting observed update ([#635](https://github.com/halojerry/poundingcore/issues/635)) ([ded7a5c](https://github.com/halojerry/poundingcore/commit/ded7a5ce7951cad942852488f30382ed7fb909da))
* **acp:** harden grok startup environment and npx recovery ([#662](https://github.com/halojerry/poundingcore/issues/662)) ([10cdd57](https://github.com/halojerry/poundingcore/commit/10cdd579849e6430c360cc88b25896ff8c146490))
* **acp:** normalize Codex full-access mode ([#608](https://github.com/halojerry/poundingcore/issues/608)) ([df51fcf](https://github.com/halojerry/poundingcore/commit/df51fcf77aa541c78c6eb6af4e987eab92b1ff07))
* **acp:** persist runtime model and mode into assistant preferences ([#482](https://github.com/halojerry/poundingcore/issues/482)) ([b9bcad9](https://github.com/halojerry/poundingcore/commit/b9bcad9d2deb94281a084c4b43a9f09c477444ed))
* **acp:** prefer config options catalogs ([#425](https://github.com/halojerry/poundingcore/issues/425)) ([9d89cc9](https://github.com/halojerry/poundingcore/commit/9d89cc9b46cc684a04c2cb9452ed9d792bd3a8de))
* **acp:** preserve confirmed model selection ([#437](https://github.com/halojerry/poundingcore/issues/437)) ([e16e11f](https://github.com/halojerry/poundingcore/commit/e16e11fa1e6ff9bd6449a8b1bc6bcfb5859fc865))
* **acp:** preserve selectors for partial config snapshots ([#548](https://github.com/halojerry/poundingcore/issues/548)) ([0cb3a9a](https://github.com/halojerry/poundingcore/commit/0cb3a9a5925b273ec1b6610c04469f8724ad14fb))
* **acp:** recover dead ACP connections ([#487](https://github.com/halojerry/poundingcore/issues/487)) ([8264873](https://github.com/halojerry/poundingcore/commit/8264873c3879a199201d3700a9f7a9a7b7ba1534))
* **acp:** redirect config-options model/mode to working endpoints ([67e918c](https://github.com/halojerry/poundingcore/commit/67e918cd0a8767cf00315d6a446b8500681cd779))
* **acp:** tolerate CodeBuddy dialect and stop misreporting empty turns as needs-auth ([#692](https://github.com/halojerry/poundingcore/issues/692)) ([572f3c1](https://github.com/halojerry/poundingcore/commit/572f3c10e1cd183c5dd759d1e10adff55655d6c9))
* add migration 033 to set Hermes/OpenClaw commands and disable all unsupported agents ([a28ed9a](https://github.com/halojerry/poundingcore/commit/a28ed9a1dedc76060248368944fcb2ce3210dd42))
* add missing fields to PlatformSpec initializers in tests ([41e1155](https://github.com/halojerry/poundingcore/commit/41e1155d6097b371d3dfb20fc2a578d4f5bc622b))
* add set_mode/set_model/set_model_confirmed defaults to IMockAgent trait ([7b7ede6](https://github.com/halojerry/poundingcore/commit/7b7ede6c7f741ff168bce8262b6edbe9c7840009))
* **agent:** adapt aionrs compat API ([#528](https://github.com/halojerry/poundingcore/issues/528)) ([f4ad432](https://github.com/halojerry/poundingcore/commit/f4ad4326342c7c93abaa1da121683d472028c2f5))
* **agent:** align unchecked availability with team runtime selection ([#571](https://github.com/halojerry/poundingcore/issues/571)) ([f80b0ce](https://github.com/halojerry/poundingcore/commit/f80b0ceac3b603c3b58e0f1a25feb31a0261f7c8))
* **agent:** avoid full availability refresh on reads ([#566](https://github.com/halojerry/poundingcore/issues/566)) ([1ffb7aa](https://github.com/halojerry/poundingcore/commit/1ffb7aa6a0fcb55a4c8966b965133ab0ace9e8b2))
* **agent:** classify ACP and provider errors ([#518](https://github.com/halojerry/poundingcore/issues/518)) ([ef573d0](https://github.com/halojerry/poundingcore/commit/ef573d0071acc0c9f4671da8a4029abea8ec2a57))
* **agent:** expose aionrs mode config option ([#501](https://github.com/halojerry/poundingcore/issues/501)) ([d1a360d](https://github.com/halojerry/poundingcore/commit/d1a360de17114dad5e1834ab2fc8531672ffd17b))
* **agent:** expose runtime catalogs from metadata ([#523](https://github.com/halojerry/poundingcore/issues/523)) ([d9c2502](https://github.com/halojerry/poundingcore/commit/d9c2502e499a6794476fcdbe63a14573b4fa81d0))
* **agent:** guard internal Aion CLI command overrides ([#538](https://github.com/halojerry/poundingcore/issues/538)) ([f141233](https://github.com/halojerry/poundingcore/commit/f141233b0cbe03a8f8ae61372d2a8fdabb9cb81c))
* **agent:** keep the thought-level picker on a resumed conversation ([#763](https://github.com/halojerry/poundingcore/issues/763)) ([dcf015e](https://github.com/halojerry/poundingcore/commit/dcf015eda00a1a5fe3952fc7eaa1c3236a5b8e9b))
* **agent:** preserve ACP error cause detail ([#581](https://github.com/halojerry/poundingcore/issues/581)) ([220f682](https://github.com/halojerry/poundingcore/commit/220f6823c1d29fde640427cfdd77de7e981758b2))
* **agent:** project available commands in management rows ([#579](https://github.com/halojerry/poundingcore/issues/579)) ([689ee8f](https://github.com/halojerry/poundingcore/commit/689ee8f91cbabd7e57c4e882f86c1ceec167e36d))
* **agent:** reflect auth failures from real turns into agent availability ([#655](https://github.com/halojerry/poundingcore/issues/655)) ([769eecb](https://github.com/halojerry/poundingcore/commit/769eecb761b3c5ee3f5cb055e972168aeea014d5))
* **agent:** reject and clear launch-path override for npx-bridged agents ([#651](https://github.com/halojerry/poundingcore/issues/651)) ([0724757](https://github.com/halojerry/poundingcore/commit/07247577c3be21b7e0aa39ead24e3afddbd13c2e))
* **agent:** send non-empty clientInfo in ACP initialize handshake ([#471](https://github.com/halojerry/poundingcore/issues/471)) ([7ea1f8e](https://github.com/halojerry/poundingcore/commit/7ea1f8ef28c0e22d147fcc471b3c8f5a2ac905d3))
* **agent:** send non-empty clientInfo in ACP initialize handshake ([#471](https://github.com/halojerry/poundingcore/issues/471)) ([5a8df22](https://github.com/halojerry/poundingcore/commit/5a8df22fd9db4b77ec0c7e9870aec78db6d7bec7))
* **agents:** honor login PATH and validate builtin CLIs ([#622](https://github.com/halojerry/poundingcore/issues/622)) ([3190be1](https://github.com/halojerry/poundingcore/commit/3190be1fae7e15be98f5f963e57a54fdee87029e))
* **agents:** persist the catalog the availability probe already fetched ([#735](https://github.com/halojerry/poundingcore/issues/735)) ([2438095](https://github.com/halojerry/poundingcore/commit/24380952e133b38b2f0192d2be09bda1f5306d5a))
* **agent:** support aionrs 0.1.31 ([#503](https://github.com/halojerry/poundingcore/issues/503)) ([d612602](https://github.com/halojerry/poundingcore/commit/d612602aa3bfa88bef60a85a1aa5cb40634055fd))
* **agent:** surface OpenClaw Gateway unreachable errors ([#498](https://github.com/halojerry/poundingcore/issues/498)) ([90d34ae](https://github.com/halojerry/poundingcore/commit/90d34aee81d484c949b3fc4358447095752e2b8d))
* **agent:** surface sign-in hint on empty ACP turns from auth-gated agents ([#653](https://github.com/halojerry/poundingcore/issues/653)) ([7a8c26e](https://github.com/halojerry/poundingcore/commit/7a8c26e31509a3794e272596e0c100168de65c7b))
* **agent:** unify CLI probe pipeline with classified failures and adaptive slow-probe recheck ([#678](https://github.com/halojerry/poundingcore/issues/678)) ([67945d2](https://github.com/halojerry/poundingcore/commit/67945d2708c8829d99f6ab4aa92cd73bc51b2bcc))
* **agent:** validate managed ACP platform binaries ([#462](https://github.com/halojerry/poundingcore/issues/462)) ([651c79f](https://github.com/halojerry/poundingcore/commit/651c79f0ec0e07009f637ebb2afa14de47c95ba3))
* **agent:** wait for task shutdown during clear ([#446](https://github.com/halojerry/poundingcore/issues/446)) ([bea814e](https://github.com/halojerry/poundingcore/commit/bea814e08ddb96ccb5d09a8016e92d179a2f318a))
* **ai-agent:** auto approve team mcp permissions ([#447](https://github.com/halojerry/poundingcore/issues/447)) ([096953e](https://github.com/halojerry/poundingcore/commit/096953e038aaa1f07333bbd6751ee927bf129e60))
* **ai-agent:** cap provider health check tokens ([1021b63](https://github.com/halojerry/poundingcore/commit/1021b631aa1b7b97d7b70d18284df21bf29dda41))
* **ai-agent:** enable official kimi k2.7 code image input ([c4b2795](https://github.com/halojerry/poundingcore/commit/c4b279583a0bf1d127d867a1d403a1f195bbed91))
* **ai-agent:** enable official kimi k2.7 code image input ([4bff331](https://github.com/halojerry/poundingcore/commit/4bff3311231e9b526a5ad27ddc74b200a8b83b3d))
* **ai-agent:** ignore max token limits for aionui requests ([0121c24](https://github.com/halojerry/poundingcore/commit/0121c24d70f4a5a63e79ee71869aee34e6b62506))
* **ai-agent:** ignore max token limits for aionui requests ([8bdf305](https://github.com/halojerry/poundingcore/commit/8bdf305e9a94d1a5aa8402424e8ef8d540eeb66c))
* **ai-agent:** pin image-capable aionrs revision ([6687805](https://github.com/halojerry/poundingcore/commit/6687805f09042b9a34b4e5ac22900374358d2671))
* **ai-agent:** resolve cron full-auto mode to backend-native YOLO (ELECTRON-3RQ) ([#699](https://github.com/halojerry/poundingcore/issues/699)) ([0b06fb5](https://github.com/halojerry/poundingcore/commit/0b06fb582a4c2eff7827909b65a86e984a1f94cf))
* **ai-agent:** set default aionrs thinking cli args ([de240a4](https://github.com/halojerry/poundingcore/commit/de240a4435058bf349acd7897b2836cff49b884d))
* **ai-agent:** token usage for the direct-CLI backends (claude / codex) ([#733](https://github.com/halojerry/poundingcore/issues/733)) ([93a24f4](https://github.com/halojerry/poundingcore/commit/93a24f43fcd0f1ecc4528b690d34ba83153f4834))
* **ai-agent:** trim stderr buffer at UTF-8 char boundary ([#443](https://github.com/halojerry/poundingcore/issues/443)) ([7380c7c](https://github.com/halojerry/poundingcore/commit/7380c7cdd3c08a51de397e6af32f22361199b592))
* AIONCORE_LISTENING → POUNDINGCORE_LISTENING ([41a2922](https://github.com/halojerry/poundingcore/commit/41a292284662510193f68de708ac7a7d11e22c10))
* **aionrs:** adapt runtime guard config ([#510](https://github.com/halojerry/poundingcore/issues/510)) ([464f453](https://github.com/halojerry/poundingcore/commit/464f4533822c8959a4d0f4d4d81d2b998152498e))
* **aionrs:** classify engine errors structurally ([#494](https://github.com/halojerry/poundingcore/issues/494)) ([8552b0a](https://github.com/halojerry/poundingcore/commit/8552b0a30f0eb323d62032986919170c05374c6a))
* **aionrs:** default missing model protocol to openai ([be519dc](https://github.com/halojerry/poundingcore/commit/be519dcc73af8e274c8d6d7e06fa103cdd115eae))
* **aionrs:** drop malformed tool-call events ([#486](https://github.com/halojerry/poundingcore/issues/486)) ([67ffbd0](https://github.com/halojerry/poundingcore/commit/67ffbd03d3aa17a46b47d6eafe08277edaaacdc4))
* **aionrs:** respect model protocol over base url ([10f3ce9](https://github.com/halojerry/poundingcore/commit/10f3ce97b569894d6e29edab9c661b9869198ef4))
* **aionrs:** stop inferring anthropic v1 suffix ([ed8f26c](https://github.com/halojerry/poundingcore/commit/ed8f26c6a1e9474984602712349e0ad2961108c4))
* **aionrs:** use versioned anthropic path for custom providers ([e300395](https://github.com/halojerry/poundingcore/commit/e30039568edda6619dbf8da99c56d23157ca031c))
* align native CLI version pins + write per-CLI manifests for offline install ([#2](https://github.com/halojerry/poundingcore/issues/2)) ([3d0c9c1](https://github.com/halojerry/poundingcore/commit/3d0c9c10d0f318fc33ff04efefb59c248984406a))
* **app:** reuse conversation service for channel messages ([#531](https://github.com/halojerry/poundingcore/issues/531)) ([dce8053](https://github.com/halojerry/poundingcore/commit/dce80538b1575a35e512f93b6da0a5b2ab7b89c4))
* **app:** stop backend when desktop exits ([#433](https://github.com/halojerry/poundingcore/issues/433)) ([d300235](https://github.com/halojerry/poundingcore/commit/d30023562bcb6d413f428fcb1dec412929a72ab3))
* **app:** use process synchronize access for parent watcher ([#438](https://github.com/halojerry/poundingcore/issues/438)) ([95571f1](https://github.com/halojerry/poundingcore/commit/95571f1c9fcd69df6ec15d8f595178c4869c15d0))
* **assistant:** canonicalize rule file storage ([#625](https://github.com/halojerry/poundingcore/issues/625)) ([020a27a](https://github.com/halojerry/poundingcore/commit/020a27a77aeb2b5be7a2b4380aab8ae2686311c4))
* **assistant:** expose auto-inject skills and preserve assistant rules ([#525](https://github.com/halojerry/poundingcore/issues/525)) ([f2e91fd](https://github.com/halojerry/poundingcore/commit/f2e91fde95ef3a84e43fbe22d71960d64686d3b0))
* **assistant:** filter generated assistants by installed agents ([#578](https://github.com/halojerry/poundingcore/issues/578)) ([5b7c366](https://github.com/halojerry/poundingcore/commit/5b7c366132006eb16e748e8fc5a0976da9a5b2a3))
* **assistant:** normalize avatar storage and identity ([#558](https://github.com/halojerry/poundingcore/issues/558)) ([155c278](https://github.com/halojerry/poundingcore/commit/155c278b7b603e8bf29e412295cec5ec50bb25fe))
* **assistant:** preserve builtin override selections ([#535](https://github.com/halojerry/poundingcore/issues/535)) ([be4a81e](https://github.com/halojerry/poundingcore/commit/be4a81ef2927c0bedef3dbf22a69fc4e8f2ffd40))
* **assistant:** remove star office helper remnants ([#470](https://github.com/halojerry/poundingcore/issues/470)) ([eec23d9](https://github.com/halojerry/poundingcore/commit/eec23d9fed25765c43ca9f5f50df91cd53d01888))
* **assistant:** skip dirty assistant bootstrap records ([#615](https://github.com/halojerry/poundingcore/issues/615)) ([f48cbc7](https://github.com/halojerry/poundingcore/commit/f48cbc757f96e3595b00f4f81330dab958f41d28))
* **assistant:** stop legacy override sync from clobbering user toggles ([#634](https://github.com/halojerry/poundingcore/issues/634)) ([346700e](https://github.com/halojerry/poundingcore/commit/346700e1d62470f84eec94b1c58fd3516d1ea90e))
* **auth:** allow same-origin framing on office preview proxy routes ([#454](https://github.com/halojerry/poundingcore/issues/454)) ([3543dbd](https://github.com/halojerry/poundingcore/commit/3543dbdc0b8ca46682b84383d2b6c4aee9bdbdd6))
* **auth:** make AionUi-&gt;AionPro data adoption a one-shot event ([#716](https://github.com/halojerry/poundingcore/issues/716)) ([c9f6f79](https://github.com/halojerry/poundingcore/commit/c9f6f79fa1a15df177e15a8ff990dcb571d2fe4c))
* **branding:** replace 'AionUi/AionUI' with 'POUNDING/poundingcore' in user-facing strings ([a95b643](https://github.com/halojerry/poundingcore/commit/a95b64369cc5428a1152f37078563fbe5bb1109d))
* bump codex-acp from 0.14.0 to 0.16.0 to fix release smoke test ([b50f29c](https://github.com/halojerry/poundingcore/commit/b50f29c93a193ca8b9ed41d12c81755e4da582ec))
* **butler:** correct three breaking field mismatches + update rule to CLI model ([#607](https://github.com/halojerry/poundingcore/issues/607)) ([b02bce6](https://github.com/halojerry/poundingcore/commit/b02bce62e5b7d847960be8d98e9f3b8c8e163e2c))
* canonicalize bundle_out path + update stale OpenClaw test ([6380a32](https://github.com/halojerry/poundingcore/commit/6380a320bc7ec7b7022dc258b6a2193f4b971f76))
* **cc-switch:** add skip-if-complete to ensure_openclaw_live_config(); fix QR HTML qrToken→qr_token ([3c69f2f](https://github.com/halojerry/poundingcore/commit/3c69f2f7580cd3c9f1ef87d4be647a1d01ef1855))
* **cc-switch:** handle legacy Codex provider config TOML format ([339e1e6](https://github.com/halojerry/poundingcore/commit/339e1e618c1e18481231c5e0302fcc01f06ba761))
* change native-cli download URL from pounding to poundingcore ([d9d2bde](https://github.com/halojerry/poundingcore/commit/d9d2bde6e30234b1fb0828b3fe86b22c695f9f66))
* **channel:** quiet WeChat poll log noise with state-transition logging and exponential backoff ([#683](https://github.com/halojerry/poundingcore/issues/683)) ([ea4da55](https://github.com/halojerry/poundingcore/commit/ea4da55a51138d76f0f539db65c165dd634a5517))
* **channel:** reuse stored credentials when re-enabling a plugin ([#458](https://github.com/halojerry/poundingcore/issues/458)) ([3920c58](https://github.com/halojerry/poundingcore/commit/3920c583db1c6a49d3209f685a8fb510967ca48a))
* **ci:** aioncore→poundingcore binary name, add feature branch triggers, update release-please ([8e13658](https://github.com/halojerry/poundingcore/commit/8e13658e73d4071b5e7719773c1c732a51287db6))
* **ci:** audit-check@v3→[@v2](https://github.com/v2), broaden branch trigger to feature/** ([5758046](https://github.com/halojerry/poundingcore/commit/575804609ded100fc16351c10de4a4997f27fab2))
* **ci:** cargo fmt + reconcile acp_config_options_e2e for CC-Switch ([2585cc6](https://github.com/halojerry/poundingcore/commit/2585cc6b78c8b57e122945e8e15d6663d9340b43))
* **ci:** prevent infinite -Pounding suffix loop in release workflow ([f23f3e8](https://github.com/halojerry/poundingcore/commit/f23f3e894c8f671e057d65bf1896e5a4b3d47b40))
* **ci:** remove AIONCORE_ALLOW_MAIN_MIGRATION_EDIT bypass ([243f644](https://github.com/halojerry/poundingcore/commit/243f644c5fb364bf0d4c07e5b79ccec4291a05ed))
* **ci:** restore main migration immutability guard ([7603d44](https://github.com/halojerry/poundingcore/commit/7603d44227f65f3d15e8b447c00c18bddd212314))
* **ci:** restore main migration immutability guard ([32121c2](https://github.com/halojerry/poundingcore/commit/32121c26b0ce572d498bac53ab6a86eedc3bceb4))
* **ci:** validate migrations against latest release ([5e21e3c](https://github.com/halojerry/poundingcore/commit/5e21e3c570705d0b1793d79ab3edc2572c84d610))
* clippy manual_unwrap_or_default in connection_test protocol ([028ce15](https://github.com/halojerry/poundingcore/commit/028ce152b581f855be2b010cbf73d80c5a7a6b39))
* co-locate npm config on staging drive to fix Windows EISDIR ([6edd7c6](https://github.com/halojerry/poundingcore/commit/6edd7c6ee86bdbd7518621d07a25cd1835de8f67))
* code review fixes — regex optimization + test cleanup ([8a4a47e](https://github.com/halojerry/poundingcore/commit/8a4a47ef032723831b33e97b6497f6a75f52b3ed))
* comprehensive cleanup - replace codex/opencode with claude/hermes, fix scripts + branding ([87ee05e](https://github.com/halojerry/poundingcore/commit/87ee05e1e81090a836c9b025704275425c7c1f56))
* **conversation:** apply a cancel that arrives while the agent is still building ([#747](https://github.com/halojerry/poundingcore/issues/747)) ([42fc44b](https://github.com/halojerry/poundingcore/commit/42fc44b51867c525759fd89d4efd7713f0c7f445))
* **conversation:** derive assistant runtime type from metadata ([#555](https://github.com/halojerry/poundingcore/issues/555)) ([236217d](https://github.com/halojerry/poundingcore/commit/236217d360ff67d0dcba906f287a34b954cb305d))
* **conversation:** partition temp workspaces and logs by date ([#560](https://github.com/halojerry/poundingcore/issues/560)) ([9bb1f33](https://github.com/halojerry/poundingcore/commit/9bb1f333065318c00da73c3a96f7fe92bea38d49))
* **conversation:** rebuild aionrs sessions from persisted runtime permission ([#661](https://github.com/halojerry/poundingcore/issues/661)) ([239c989](https://github.com/halojerry/poundingcore/commit/239c989a09c53ba85bebf714680fc924c8771f06))
* **conversation:** recover dead ACP turns after agent process loss ([#514](https://github.com/halojerry/poundingcore/issues/514)) ([e0ce4f4](https://github.com/halojerry/poundingcore/commit/e0ce4f4b67c44dff196d122216bd81bb42ca9ea9))
* **conversation:** request plaintext thinking from claude, drop blank thought cards ([#731](https://github.com/halojerry/poundingcore/issues/731)) ([9cd4fb9](https://github.com/halojerry/poundingcore/commit/9cd4fb99648c7d624fa3f897b6291fea51b7c034))
* **conversation:** return 404 for nonexistent conversation in get_slash_commands, get/set_config_options ([01d2346](https://github.com/halojerry/poundingcore/commit/01d234633490aa618d0426f0cf7edd3b388251ce))
* **conversation:** return 404 for set_model on nonexistent conversation ([82f398f](https://github.com/halojerry/poundingcore/commit/82f398fe9dcbc06a438f107bfa1beb62f2fb4000))
* **conversation:** upsert streaming tool calls (AIO-30) ([#484](https://github.com/halojerry/poundingcore/issues/484)) ([a0b3737](https://github.com/halojerry/poundingcore/commit/a0b3737bf6a60c6f5483d4112dc4f4f733a9e6fa))
* **cron:** apply custom assistant rules in scheduled runs ([#495](https://github.com/halojerry/poundingcore/issues/495)) ([3840b77](https://github.com/halojerry/poundingcore/commit/3840b77f4f4dc26b58481868507e07e13fb9fbd1))
* **cron:** enforce full-auto mode for scheduled tasks ([#576](https://github.com/halojerry/poundingcore/issues/576)) ([cf0a9bd](https://github.com/halojerry/poundingcore/commit/cf0a9bd88ac295fe8b40a6c1f9f21174b574718d))
* **cron:** lock team cron execution mode ([#562](https://github.com/halojerry/poundingcore/issues/562)) ([56f3873](https://github.com/halojerry/poundingcore/commit/56f38734844164707782b795627a8d65ff1b3c16))
* **cron:** preserve existing conversation jobs across lifecycle changes ([#572](https://github.com/halojerry/poundingcore/issues/572)) ([fa4217a](https://github.com/halojerry/poundingcore/commit/fa4217a6d4ba0cde4d4c7d0d5460969b94eb6c4a))
* **cron:** restore create command heading ([#547](https://github.com/halojerry/poundingcore/issues/547)) ([1a30f77](https://github.com/halojerry/poundingcore/commit/1a30f7710de2c98856f7256811543c1121dddc76))
* **cron:** retry busy jobs from runtime state ([#459](https://github.com/halojerry/poundingcore/issues/459)) ([9918058](https://github.com/halojerry/poundingcore/commit/9918058788e07508ee61fc841e4c85cf757b8bb6))
* **cron:** route skill scheduling through helper ([#553](https://github.com/halojerry/poundingcore/issues/553)) ([c57970f](https://github.com/halojerry/poundingcore/commit/c57970fed387ba895dd934f85c4c59af63da6cfa))
* **cron:** run jobs through conversation service ([#546](https://github.com/halojerry/poundingcore/issues/546)) ([b36fb5c](https://github.com/halojerry/poundingcore/commit/b36fb5c471b19edefd0b63dc2acf3e3d4c2c52ae))
* **cron:** use host timezone for conversation cron ([#652](https://github.com/halojerry/poundingcore/issues/652)) ([00ddaa5](https://github.com/halojerry/poundingcore/commit/00ddaa574b2ed4a8bdb2a68a0fe46af69d7ab16b))
* **cron:** use host timezone for conversation cron ([#652](https://github.com/halojerry/poundingcore/issues/652)) ([19b36f8](https://github.com/halojerry/poundingcore/commit/19b36f8ee3e67b5ffe58a0ca333696a880c22c9b))
* **database:** require explicit corrupted database recovery ([#563](https://github.com/halojerry/poundingcore/issues/563)) ([203bd1b](https://github.com/halojerry/poundingcore/commit/203bd1b574438cf730c351879a773a82548b972c))
* **db:** pre-migration repair for migration-030 startup-blocking CHECK failures ([#724](https://github.com/halojerry/poundingcore/issues/724)) ([859ed7e](https://github.com/halojerry/poundingcore/commit/859ed7e5bdd2da5664b0f1d2df4e2b9cd92aaf3b))
* **db:** prevent duplicate migration versions ([af88855](https://github.com/halojerry/poundingcore/commit/af88855a5e1610797689debd81755136f740cc2d))
* **db:** prevent duplicate migration versions ([39b74ba](https://github.com/halojerry/poundingcore/commit/39b74ba1befeb052a673edaf9f05313c774fc1d7))
* **db:** remove duplicate migration 010_add_pounding_cli.sql (replaced by 013) ([8bc19aa](https://github.com/halojerry/poundingcore/commit/8bc19aac828a57de5d0c95f5b93cd82fe1b62fc1))
* **db:** rename 010_add_pounding_cli.sql → 015 to resolve migration version conflict ([2ebedda](https://github.com/halojerry/poundingcore/commit/2ebedda406db1502b14ddb00e1682967e1f33a52))
* **db:** repair legacy handoff schema drift ([#516](https://github.com/halojerry/poundingcore/issues/516)) ([292e5f2](https://github.com/halojerry/poundingcore/commit/292e5f2d6fc727f41f4164d5f51cfa37c103b060))
* **db:** widen migration-030 pre-repair gate to any pre-030 start point ([#756](https://github.com/halojerry/poundingcore/issues/756)) ([6e2b33d](https://github.com/halojerry/poundingcore/commit/6e2b33d75bfa0b5c504514fc25d1f09d6db7b3f7))
* defend against npm packages with broken exports/main paths in smoke test ([3822757](https://github.com/halojerry/poundingcore/commit/38227579c686c370681602ae38dd18323bb7a71c))
* **deps:** update quinn-proto for RustSec advisory ([#508](https://github.com/halojerry/poundingcore/issues/508)) ([05df6f7](https://github.com/halojerry/poundingcore/commit/05df6f7c2d924b94d1514bcee4ff835ea0e0b0fb))
* disable native CLI downloads (hermes/opencode/openclaw) that always return 404 ([348e1e1](https://github.com/halojerry/poundingcore/commit/348e1e1dcff30628bc3febe914c453f8079453c6))
* eliminate remaining POUNDING-introduced warnings ([387b857](https://github.com/halojerry/poundingcore/commit/387b8571a7696364c129eeb0fdc94cd05ee70304))
* **error:** canonicalize boundary errors ([#415](https://github.com/halojerry/poundingcore/issues/415)) ([84e04e1](https://github.com/halojerry/poundingcore/commit/84e04e122dad19eee712af29d3b5bd3f631a6fe1))
* expose managed resource preparation failure details ([#430](https://github.com/halojerry/poundingcore/issues/430)) ([e010024](https://github.com/halojerry/poundingcore/commit/e010024fce3975fe5f6930c24377bde9f636b55b))
* extend CC-Switch model/env injection to Hermes backend ([c3da25c](https://github.com/halojerry/poundingcore/commit/c3da25cac1b83745c0960bbe7bda37fa4147bab5))
* feedback_diagnostics fixture 列/bind 错位（opencode→hermes 适配引入） ([f226199](https://github.com/halojerry/poundingcore/commit/f2261994b255707d7223b51a8cae2c7a439504de))
* **file-watch:** degrade gracefully when watcher init fails instead of killing backend ([#751](https://github.com/halojerry/poundingcore/issues/751)) ([bdb6d61](https://github.com/halojerry/poundingcore/commit/bdb6d619c62cd5294bb09248b86b10fc5cd9ba1f))
* **file:** strip verbatim \\?\ prefix from non-browse path outputs ([#736](https://github.com/halojerry/poundingcore/issues/736)) ([782ddd0](https://github.com/halojerry/poundingcore/commit/782ddd083074bec1857a3a9b5bc64852ae525c4f))
* **file:** strip Windows verbatim prefix from /api/fs/browse paths ([#453](https://github.com/halojerry/poundingcore/issues/453)) ([f8c3f95](https://github.com/halojerry/poundingcore/commit/f8c3f950f9897c4e13ae7bb1dbb7816017b86480))
* **file:** trust local workspace roots for fs routes ([#527](https://github.com/halojerry/poundingcore/issues/527)) ([8e6f32f](https://github.com/halojerry/poundingcore/commit/8e6f32fe1eda91177d794dca80c87cff3cd970fa))
* final clippy::collapsible_if fix + cargo fmt --all ([021023c](https://github.com/halojerry/poundingcore/commit/021023ca6a8ccce51888fe3ea18cc7a19021e16b))
* final clippy::collapsible_if fix + cargo fmt --all ([9b79932](https://github.com/halojerry/poundingcore/commit/9b79932d9b2fdcd26c3d02f968930dcb45416837))
* final clippy::collapsible_if fix + cargo fmt --all ([e61f1e6](https://github.com/halojerry/poundingcore/commit/e61f1e638bcf043f73677b7872b181e3495ede4b))
* final clippy::collapsible_if fix + cargo fmt --all ([b52c94c](https://github.com/halojerry/poundingcore/commit/b52c94c01d0126bead96f88743d11ce6a8d6bd53))
* final clippy::collapsible_if fix + cargo fmt --all ([f466445](https://github.com/halojerry/poundingcore/commit/f466445fe869a4be5b17bfc477aeb1ebab87fe97))
* final clippy::collapsible_if fix + cargo fmt --all ([bc70a90](https://github.com/halojerry/poundingcore/commit/bc70a90ded709b6544a7ef0c1b1e458e58225e04))
* handle absolute bin paths in smoke test (codex-acp) ([7196b02](https://github.com/halojerry/poundingcore/commit/7196b02255f5caa844941806f808e5bbea67604b))
* handle Hermes yolo fallback correctly ([#428](https://github.com/halojerry/poundingcore/issues/428)) ([e10d264](https://github.com/halojerry/poundingcore/commit/e10d26460ac6dabf292f8b1edd7eeb1c1ffd5cad))
* harden ACP image path handling ([#477](https://github.com/halojerry/poundingcore/issues/477)) ([c79b5a8](https://github.com/halojerry/poundingcore/commit/c79b5a8a010fee82219579873a062bcca5c71fc2))
* harden managed ACP bundle preparation and builtin CLI availability ([#426](https://github.com/halojerry/poundingcore/issues/426)) ([e0121f9](https://github.com/halojerry/poundingcore/commit/e0121f938e0160f48d2f57e9205f78bf31b92233))
* improve OpenClaw diagnostics + Codex session rebuild logging ([004f230](https://github.com/halojerry/poundingcore/commit/004f2309c8d64d22454c7fb0a2318d554c5e1275))
* increase idle timeout to 15min + inject OpenClaw env vars in generic spawn path ([d1f53e2](https://github.com/halojerry/poundingcore/commit/d1f53e299645fa15c1a4734b7bf1d16991d2fea1))
* isolate ACP cancel turn completion ([#461](https://github.com/halojerry/poundingcore/issues/461)) ([ea01ee6](https://github.com/halojerry/poundingcore/commit/ea01ee6849d66dad698fee48f6374233d23985ae))
* load skills in custom workspaces ([#506](https://github.com/halojerry/poundingcore/issues/506)) ([d73c398](https://github.com/halojerry/poundingcore/commit/d73c39855c1863e0606aedcb6c4ef8ebffeec8cc))
* make cancel endpoint accept optional turn_id to prevent 400 errors ([c0a4b70](https://github.com/halojerry/poundingcore/commit/c0a4b7030ed74cbec58d7f115d05bdf00f3db9e6))
* make native CLI preparation non-fatal in Release CI ([4f6175f](https://github.com/halojerry/poundingcore/commit/4f6175f7c4bc7d85784deeeed0fc48dc54f017a9))
* make smoke test non-fatal (EISDIR on Windows node --check) ([5964962](https://github.com/halojerry/poundingcore/commit/596496288498d7fdc7c131702663be351c1ce699))
* **managed-resources:** emit bundled resource manifest ([#617](https://github.com/halojerry/poundingcore/issues/617)) ([64b5062](https://github.com/halojerry/poundingcore/commit/64b506239639c632eb5f6acb4495e58e74c64167))
* **mcp:** support aionrs config path subcommand with legacy fallback ([#568](https://github.com/halojerry/poundingcore/issues/568)) ([72cfba1](https://github.com/halojerry/poundingcore/commit/72cfba1909d663117615a595316804c7707bdfd3))
* missing tempfile:: prefix on tempdir() call ([7e7ba4a](https://github.com/halojerry/poundingcore/commit/7e7ba4abcdcb64c53eeecdde0219f3f391bb41cc))
* **model_fetcher:** extract first key from multi-line api_key for HTTP requests ([#593](https://github.com/halojerry/poundingcore/issues/593)) ([1161647](https://github.com/halojerry/poundingcore/commit/116164756544306ef8ac257106a03e665c85cf3d))
* **native-cli:** replace dead download fallback with clear install instructions ([33fb83f](https://github.com/halojerry/poundingcore/commit/33fb83f81507a4a41445f13eb7462bc62601078b))
* **native-cli:** update native CLI version pins to official latest ([1f774d1](https://github.com/halojerry/poundingcore/commit/1f774d168f531aaead61861f0b702c012278d21e))
* **new-api:** fetch only POUNDING group models, not all models ([2ccfecc](https://github.com/halojerry/poundingcore/commit/2ccfecc2166e12fc30f07ed5ff28916c52adfce9))
* **new-api:** rewrite fetch_models_at_url — single parse via text() ([e430bd6](https://github.com/halojerry/poundingcore/commit/e430bd69319f300b97c6968048c8fa4323731554))
* **new-api:** use ?grouped=true + extract POUNDING group models ([22cdc9c](https://github.com/halojerry/poundingcore/commit/22cdc9cd88a5fd405c88ffe981be9e713fd4a8f9))
* **office:** fetch officecli installer from official mirror before GitHub ([#463](https://github.com/halojerry/poundingcore/issues/463)) ([08fbc6f](https://github.com/halojerry/poundingcore/commit/08fbc6f12d154d5419ae1b092a1a9352ee64250e))
* **office:** probe star-office preferred_url host as given ([#456](https://github.com/halojerry/poundingcore/issues/456)) ([3c2149c](https://github.com/halojerry/poundingcore/commit/3c2149ca92aad8a0e19fae0d8083083500f60267))
* **office:** resolve officecli shim from node_modules/.bin after npm prefix install ([#440](https://github.com/halojerry/poundingcore/issues/440)) ([2fe76ee](https://github.com/halojerry/poundingcore/commit/2fe76eebbaab1d323b4f81acaff8187a0c00bac7))
* **office:** restore OfficeCLI installer resolution ([#444](https://github.com/halojerry/poundingcore/issues/444)) ([009e133](https://github.com/halojerry/poundingcore/commit/009e133e9e914556a579f27a3671fb5ff47333f7))
* preserve ACP config catalogs on resume ([#570](https://github.com/halojerry/poundingcore/issues/570)) ([a9c1955](https://github.com/halojerry/poundingcore/commit/a9c19553bad1da3283f5dfad1972cd1ed1992546))
* preserve assistant snapshot and skill wiring for cron ([#473](https://github.com/halojerry/poundingcore/issues/473)) ([2d47d8c](https://github.com/halojerry/poundingcore/commit/2d47d8cca71c4d0fdc3d1c2b93916c03b8c3b42c))
* preserve Linux GLIBC baselines ([#573](https://github.com/halojerry/poundingcore/issues/573)) ([ab6e227](https://github.com/halojerry/poundingcore/commit/ab6e227504c40f78823988d4c10af8fd153cc47c))
* prevent silent encryption-key rotation on migration upgrade (ELECTRON-3T0) ([#722](https://github.com/halojerry/poundingcore/issues/722)) ([4993fe8](https://github.com/halojerry/poundingcore/commit/4993fe858c531f6b2ca471ad59612d46e97d9de9))
* **process:** allow whitespace in workspace cwd segments ([#410](https://github.com/halojerry/poundingcore/issues/410) parity) ([#674](https://github.com/halojerry/poundingcore/issues/674)) ([c344b02](https://github.com/halojerry/poundingcore/commit/c344b028edf291b30d17d0a823bdab5ca74efe1f))
* **process:** reap tool subprocesses that left the process group ([#753](https://github.com/halojerry/poundingcore/issues/753)) ([7bc0260](https://github.com/halojerry/poundingcore/commit/7bc026006c55a7f38d94f86a44af6d36105284b3))
* **project/monitor:** attribute watched-subdir events to parent so tree reflects dir delete/rename ([#734](https://github.com/halojerry/poundingcore/issues/734)) ([8494a1f](https://github.com/halojerry/poundingcore/commit/8494a1f95f7c8c08f85b1d30d2d39c99770325a5))
* **project:** add temporary fs/resolve command for preview file paths ([#723](https://github.com/halojerry/poundingcore/issues/723)) ([575feac](https://github.com/halojerry/poundingcore/commit/575feacd9e5aef7b7948a882bdb9ce27050e2829))
* **provider:** preserve automatic vision detection ([08696fd](https://github.com/halojerry/poundingcore/commit/08696fd0b46794497c7bf70473874753a66c1925))
* QR login query-param fallback + clippy fixes ([39a3c05](https://github.com/halojerry/poundingcore/commit/39a3c0502af1c7f566230abf99101a7ba8fd12db))
* QR login query-param fallback + clippy fixes ([24ff0e5](https://github.com/halojerry/poundingcore/commit/24ff0e5ce8bdea7ab3687eba951afc5a6e753104))
* refactor npm config into NpmConfig struct to fix clippy too_many_arguments ([db6dbc1](https://github.com/halojerry/poundingcore/commit/db6dbc1df43a9d5148404dae236ae1bf81f87d3c))
* remove async from clear() in IWorkerTaskManager mock impls ([02b4398](https://github.com/halojerry/poundingcore/commit/02b439885a903beddbd86a896f0b1cb1c461353d))
* remove codex and opencode from PRESET_AGENT_TYPES ([#1](https://github.com/halojerry/poundingcore/issues/1)) ([ae422fe](https://github.com/halojerry/poundingcore/commit/ae422fec00c01d21310fab9dbaa6965e79660725))
* remove codex from REQUIRED_CLI_NAMES in managed resources contract ([eb10c86](https://github.com/halojerry/poundingcore/commit/eb10c863155e1c8222407807087007b5fdbf4f03))
* remove duplicate POUNDING migration files at 022-024; already renumbered to 028-030 ([b3cc428](https://github.com/halojerry/poundingcore/commit/b3cc4284a142b83cc892b4c4545c7edad8e0ab03))
* remove OpenCode references from native CLI tests ([273ca4e](https://github.com/halojerry/poundingcore/commit/273ca4ec1083ad4d5ded81977afa7080cf3904dc))
* rename DB aionui-backend.db → pounding-backend.db, accept numeric user.id ([1d8ca3f](https://github.com/halojerry/poundingcore/commit/1d8ca3f839ca130767acb6ed5232c1fb150f6b09))
* renumber POUNDING migrations 007→010, 008→011 to avoid upstream collision ([dc50018](https://github.com/halojerry/poundingcore/commit/dc50018124649c43a4fdc1bc0390b0288f3a54f9))
* renumber upstream migrations (020→023, 021→024) to avoid conflicts ([904219b](https://github.com/halojerry/poundingcore/commit/904219bb1871b63bba0595567cfb4f1fafaff88d))
* repair invalid UTF-8 agent metadata cache fields ([#526](https://github.com/halojerry/poundingcore/issues/526)) ([91969cd](https://github.com/halojerry/poundingcore/commit/91969cd765dbecf962ba3c986eb271dfc8208c0b))
* replace CARGO_BIN_EXE_aioncore with poundingcore, suppress more dead code ([7c97b37](https://github.com/halojerry/poundingcore/commit/7c97b37e0086e91bc82ce73a1de5923ffae477e1))
* replace Codex agent ID 8e1acf31 with Claude agent ID 2d23ff1c ([646da87](https://github.com/halojerry/poundingcore/commit/646da87c467696e298f140abeac29a42106e13ac))
* replace codex/opencode agent lookups with hermes/claude in tests ([d8aab63](https://github.com/halojerry/poundingcore/commit/d8aab6352bb4bb5405a6acce429c04fce91a0840))
* resolve ACP backends from metadata ([#559](https://github.com/halojerry/poundingcore/issues/559)) ([6c15bb7](https://github.com/halojerry/poundingcore/commit/6c15bb765f8c84baddd89830839c832424ef1789))
* resolve clippy unwrap-or-else and test mock trait mismatches ([f5dd658](https://github.com/halojerry/poundingcore/commit/f5dd658a022cabec0d21ffa7e4ba6b0df2c875a4))
* resolve compile errors after v2.1.34 merge ([1374177](https://github.com/halojerry/poundingcore/commit/1374177242b8cca41a81eff115dd6a6052906c18))
* resolve duplicate imports and undefined normalized_model_id ([d62f5c7](https://github.com/halojerry/poundingcore/commit/d62f5c715f5ce22ab61c2894342ad0a04812c45e))
* restore full repo tree after accidental deletion ([15e7d8e](https://github.com/halojerry/poundingcore/commit/15e7d8e6616663c17f5d28684e8bf1ae6e4a32dd))
* restore managed-runtime + doctor HTTP routes; drop star-office-helper builtin ([#3](https://github.com/halojerry/poundingcore/issues/3)) ([43b5a29](https://github.com/halojerry/poundingcore/commit/43b5a29ff570d774d9f661970059eb33b3e5dcd4))
* restore model_identity_reminder module declaration in capability/mod.rs ([17edd32](https://github.com/halojerry/poundingcore/commit/17edd32a7453980b0c492e8a5b40dcbbd4442fe6))
* restore POUNDING agent API wrappers + native CLI support after session-port merge ([f295606](https://github.com/halojerry/poundingcore/commit/f295606f5633b4fc82608542ad089462b476c0b8))
* robust smoke test path resolution + conversation existence check for get_model ([9f5a117](https://github.com/halojerry/poundingcore/commit/9f5a117a411c7c41e63616ec54d01eb2dfc1dedf))
* **runtime:** add bounded retry to managed node version probe ([#771](https://github.com/halojerry/poundingcore/issues/771)) ([1dee9f1](https://github.com/halojerry/poundingcore/commit/1dee9f1e961a529f7aae701f97ddb1deeab64655))
* **runtime:** harden managed Node command resolution ([#565](https://github.com/halojerry/poundingcore/issues/565)) ([e69b83a](https://github.com/halojerry/poundingcore/commit/e69b83a836b369b4244a04b64f931bea1dd54743))
* **runtime:** protect active ACP tasks from idle cleanup ([#561](https://github.com/halojerry/poundingcore/issues/561)) ([1fa7a54](https://github.com/halojerry/poundingcore/commit/1fa7a543e8fd4cec7e423443cbd6299de6a761ad))
* **runtime:** report bundled resource installation failures ([#420](https://github.com/halojerry/poundingcore/issues/420)) ([bc4b7d9](https://github.com/halojerry/poundingcore/commit/bc4b7d9315727b1e4fe00cb54c1230828dd37cf1))
* **runtime:** retry transient bundled-node activation copy and reclassify persistent I/O failures ([#760](https://github.com/halojerry/poundingcore/issues/760)) ([23d2ec6](https://github.com/halojerry/poundingcore/commit/23d2ec658dd3dfda89156f7119945ac3c7141611))
* **runtime:** update Claude ACP package ([#599](https://github.com/halojerry/poundingcore/issues/599)) ([cf69332](https://github.com/halojerry/poundingcore/commit/cf693323913c31d3276a5e103b434c6ca51b519e))
* **runtime:** update managed Codex ACP package ([#598](https://github.com/halojerry/poundingcore/issues/598)) ([1bb2be7](https://github.com/halojerry/poundingcore/commit/1bb2be72a040d16f284d4a0b5b2de670aa2f864b))
* scope bundled ACP output under tool directories ([#431](https://github.com/halojerry/poundingcore/issues/431)) ([d079395](https://github.com/halojerry/poundingcore/commit/d079395b0679d5b9450497a4d088bc478c5cf45f))
* **server:** emit AIONCORE_READY marker once serving begins ([#761](https://github.com/halojerry/poundingcore/issues/761)) ([8b08130](https://github.com/halojerry/poundingcore/commit/8b08130365ec7c883736c0b4aabcef471002dd7b))
* **session:** carry tool input on permission events so the approval card shows what is being approved ([#715](https://github.com/halojerry/poundingcore/issues/715)) ([bdbb11c](https://github.com/halojerry/poundingcore/commit/bdbb11c7f32547996fe6e33b0a4d8b833cb7279b))
* **session:** force-kill direct-CLI turns on UserCancelTimeout ([#702](https://github.com/halojerry/poundingcore/issues/702)) ([34119ce](https://github.com/halojerry/poundingcore/commit/34119ce01ff6702be7428dfc33aba79add160fac))
* **session:** keep claude session cost cumulative across process respawns ([#767](https://github.com/halojerry/poundingcore/issues/767)) ([f498e9d](https://github.com/halojerry/poundingcore/commit/f498e9d2deb57d3491d5a107b622d24d5c8df7df))
* **session:** preserve codex's real error when systemError precedes the terminal ([#694](https://github.com/halojerry/poundingcore/issues/694)) ([994e3fe](https://github.com/halojerry/poundingcore/commit/994e3fe27c9c673e28cda2de23828501066af04b))
* **session:** restore codex slash commands + recover dead resume anchors on the direct-CLI path ([#679](https://github.com/halojerry/poundingcore/issues/679)) ([7b60611](https://github.com/halojerry/poundingcore/commit/7b606113c36051d533f4463849060c4be8310552))
* **session:** settle cancelled workflows and stop per-turn pump state leaking across turns ([#732](https://github.com/halojerry/poundingcore/issues/732)) ([b8a4a88](https://github.com/halojerry/poundingcore/commit/b8a4a882f50838d2e26211a2f3f8713a0eded1b9))
* **session:** settle cards through teardown and resume so no stored row spins forever ([#766](https://github.com/halojerry/poundingcore/issues/766)) ([3f61cc4](https://github.com/halojerry/poundingcore/commit/3f61cc490ec589f6602eeeb30487443cd9d1061e))
* **shell:** reveal file via FileManager1 D-Bus on Linux ([#466](https://github.com/halojerry/poundingcore/issues/466)) ([98c75ec](https://github.com/halojerry/poundingcore/commit/98c75ecc1bf20263f9bb682d8729d0924060f178))
* **shell:** support UNC paths in Windows terminal ([#411](https://github.com/halojerry/poundingcore/issues/411)) ([a041953](https://github.com/halojerry/poundingcore/commit/a04195329996b921cee811066994efb885b833e1))
* **skill:** raise import size limits ([#564](https://github.com/halojerry/poundingcore/issues/564)) ([50d9aff](https://github.com/halojerry/poundingcore/commit/50d9affe53ad64e994564a31215caab428eb7094))
* **skills:** correct AionUi Butler skill drift against current backend ([#557](https://github.com/halojerry/poundingcore/issues/557)) ([41c2c94](https://github.com/halojerry/poundingcore/commit/41c2c9426eefb2ce29de4a9f5b4e10c862a63994))
* **skills:** correct aionui-config butler skill drift (2026-07) ([#584](https://github.com/halojerry/poundingcore/issues/584)) ([e72e03f](https://github.com/halojerry/poundingcore/commit/e72e03ff6e1366f705352bcefec474887a85adfa))
* **skills:** quote marketing-skills description (invalid YAML frontmatter) ([262bdd9](https://github.com/halojerry/poundingcore/commit/262bdd9cf7228261079cf0fe5e91fe5d06b97454))
* **skills:** repair butler cron and doc drift (2026-07-22 audit) ([#664](https://github.com/halojerry/poundingcore/issues/664)) ([a7610b7](https://github.com/halojerry/poundingcore/commit/a7610b767b5b8a46b677084a7e169f2fbbf9d3c2))
* **skills:** repair butler cron and doc drift (2026-07-22 audit) ([#664](https://github.com/halojerry/poundingcore/issues/664)) ([273ac47](https://github.com/halojerry/poundingcore/commit/273ac476bc892edb7bb63429e423e0b4928bcad0))
* **skills:** repair butler endpoint drift + add cron scheduling ([#550](https://github.com/halojerry/poundingcore/issues/550)) ([88bcff3](https://github.com/halojerry/poundingcore/commit/88bcff3c08ebcd5e5dff8f16ba9c68fa313ef55f))
* **skills:** sync AionUi Butler skills + rule with current backend ([#520](https://github.com/halojerry/poundingcore/issues/520)) ([5603b9a](https://github.com/halojerry/poundingcore/commit/5603b9a77857b08d99d45c02eeeeb4d6d1e1e98a))
* skip npm packages with absolute main/exports paths in smoke test ([115320d](https://github.com/halojerry/poundingcore/commit/115320d9ed1c6c4a6ddad75152eae021dc686684))
* **startup:** make concurrent aioncore startup safe over one data directory ([#657](https://github.com/halojerry/poundingcore/issues/657)) ([2a64b55](https://github.com/halojerry/poundingcore/commit/2a64b55e1ab52f789dcb3a715ef0a940b35a20b3))
* stop defaulting aionrs max tokens ([22bc24b](https://github.com/halojerry/poundingcore/commit/22bc24b1f30ef4d475ccada7d36b3ee977054eba))
* **stt:** STT compatibility fixes for Groq Whisper and AionUI web frontend ([#400](https://github.com/halojerry/poundingcore/issues/400)) ([4c3fa09](https://github.com/halojerry/poundingcore/commit/4c3fa094087c8479d0c2975ec896ce46fb37abca))
* **stt:** treat blank base_url as unset and log malformed config ([#448](https://github.com/halojerry/poundingcore/issues/448)) ([f6b653b](https://github.com/halojerry/poundingcore/commit/f6b653bbdd5822dcd1b52790f0cf28db65115011))
* sync advertised.config_options after mode/model switch, add MCP connection test diagnostics ([5c9e199](https://github.com/halojerry/poundingcore/commit/5c9e199c0771d1e4988c5080de7b304f87cb4b51))
* **system:** apply keep-awake client preference ([#642](https://github.com/halojerry/poundingcore/issues/642)) ([a6a290d](https://github.com/halojerry/poundingcore/commit/a6a290dd374a37eca73fc008c25bd6780a0e1f54))
* **system:** release keep-awake on shutdown ([#666](https://github.com/halojerry/poundingcore/issues/666)) ([d4fb73e](https://github.com/halojerry/poundingcore/commit/d4fb73ec1696b1aabcca8aee526b894bb12873a4))
* **system:** release keep-awake on shutdown ([#666](https://github.com/halojerry/poundingcore/issues/666)) ([6e0b3a7](https://github.com/halojerry/poundingcore/commit/6e0b3a73a6bc8fca6f7c5378760d352bfe6e667c))
* **team:** broadcast Stopped status on idle-cleanup team reclaim ([#640](https://github.com/halojerry/poundingcore/issues/640)) ([024a3a5](https://github.com/halojerry/poundingcore/commit/024a3a578936af0c59ed5aeed7bc1b4c20d990ea))
* **team:** converge run-scoped wakes into a run at the enqueue choke-point ([#690](https://github.com/halojerry/poundingcore/issues/690)) ([c6fdcde](https://github.com/halojerry/poundingcore/commit/c6fdcde549c9ebcd0aa91c018758b8bea960ea70))
* **team:** converge system/lifecycle wakes into a team run ([#680](https://github.com/halojerry/poundingcore/issues/680)) ([38facd7](https://github.com/halojerry/poundingcore/commit/38facd70868fe25135b01fd6e276dc816abddc05))
* **team:** derive team capability from probed MCP transports, not a stored veto ([#725](https://github.com/halojerry/poundingcore/issues/725)) ([d60fc62](https://github.com/halojerry/poundingcore/commit/d60fc6297c3477658f4cdc635f6de7540230d28f))
* **team:** dispatch native slash commands as bare command turns ([#696](https://github.com/halojerry/poundingcore/issues/696)) ([45d4e71](https://github.com/halojerry/poundingcore/commit/45d4e715e34749b75f9ba671f59e98766e2ed14d))
* **team:** inherit workspace for spawned agents ([#413](https://github.com/halojerry/poundingcore/issues/413)) ([82b31c5](https://github.com/halojerry/poundingcore/commit/82b31c5fbdb1e30a580865b4c441b1ac93ec5181))
* **team:** retry handoff turns after runtime release ([#480](https://github.com/halojerry/poundingcore/issues/480)) ([77d252f](https://github.com/halojerry/poundingcore/commit/77d252fdd7e43c740043bc3f7963a06a1461fec8))
* **team:** use first enabled provider as fallback when model lookup fails for aionrs; prevents Provider 'aionrs' not found on session warmup ([3499e6a](https://github.com/halojerry/poundingcore/commit/3499e6a0e28e7265a2963471d4df353c887ba8af))
* **test:** aionrs logo assertion expects POUNDING heart, not aion.svg ([523d8c1](https://github.com/halojerry/poundingcore/commit/523d8c1e9f2430a93a38a3bcdb9e51838d2ed4ac))
* **test:** command_ack test uses generic option, not CC-Switch model ([2945488](https://github.com/halojerry/poundingcore/commit/294548829cc0deb4588709b59382b1d03c3bf035))
* **test:** restore MockAgent.set_mode + align set_config_option tests ([cb66abf](https://github.com/halojerry/poundingcore/commit/cb66abf40368136a4f4774f49058f435a37d2735))
* **test:** update avatar test after fixing word-form-creator emoji avatar ([df952d6](https://github.com/halojerry/poundingcore/commit/df952d62664d9efd54a0d32e2fa1caa845fa6e50))
* update branding skill path and suppress managed-runtime 404 ([8b455a6](https://github.com/halojerry/poundingcore/commit/8b455a630e07168f7458a6d6453eb86245be4007))
* update check-branding.sh for renamed migration and skill paths ([13258ea](https://github.com/halojerry/poundingcore/commit/13258eaf2112323de2c4fab2079799c003daf6eb))
* update embedded codex strings in channel test assertion ([8e42693](https://github.com/halojerry/poundingcore/commit/8e4269341ce35c52e26033fa79610a382347aae5))
* update pounding-expert description to only reference active CLIs (remove Codex, OpenCode) ([0a8f27d](https://github.com/halojerry/poundingcore/commit/0a8f27d316070058a7795e71cbfbe1125114fb65))
* update session_context test assertions after hermes rename ([26f3990](https://github.com/halojerry/poundingcore/commit/26f3990ecda2a836cd4e3ff83c805d5f74501416))
* update smoke test to create actual file for entrypoint check ([7759177](https://github.com/halojerry/poundingcore/commit/775917795962fcec2826c71cbee9c90080341ad3))
* use Path::is_absolute() instead of starts_with('/') for Windows smoke test ([4ab7e7c](https://github.com/halojerry/poundingcore/commit/4ab7e7c03bdf8dcbcbafe3fba1a1bb904e41a63c))
* use provider and model protocol to determine llm request. ([37f76a8](https://github.com/halojerry/poundingcore/commit/37f76a8bf1ba8aafabb5dd6b6062da40173ef010))
* use temp_dir() for bundle staging to avoid Windows MAX_PATH ([e04fd5a](https://github.com/halojerry/poundingcore/commit/e04fd5acdb2b8dcc47b919cdaabd29f885466637))
* user_scope_migration 测试迁移号 +6 位移（上游 028-037 → 034-043） ([aae656b](https://github.com/halojerry/poundingcore/commit/aae656bc734e12f0f3a716039079274c1f6dddfa))
* validate managed ACP packages via real entrypoints ([#429](https://github.com/halojerry/poundingcore/issues/429)) ([77221dd](https://github.com/halojerry/poundingcore/commit/77221ddddd883c56b954ca5cfea0f98038754efe))
* validate skill frontmatter as yaml ([#512](https://github.com/halojerry/poundingcore/issues/512)) ([6b46055](https://github.com/halojerry/poundingcore/commit/6b460552b63cdb6242703831c25443d9153fc25e))
* **windows:** handle runtime process lifecycle ([399f920](https://github.com/halojerry/poundingcore/commit/399f920c31ab4d738ffa32b5ebcff9416ba44e6f))
* 测试矩阵修复 + 迁移重复清理 + branding 脚本 ozon 路径修正 ([bbeaa72](https://github.com/halojerry/poundingcore/commit/bbeaa7232cbd00b28b59b1e7d820c8210e39542e))


### Code Refactoring

* **acp:** upgrade agent-client-protocol SDK 0.11.1 -&gt; 2.0.0 ([#708](https://github.com/halojerry/poundingcore/issues/708)) ([9e185f0](https://github.com/halojerry/poundingcore/commit/9e185f0b196e6945b4d716553968150cb162c7ba))
* **app:** organize CLI command boundaries ([#423](https://github.com/halojerry/poundingcore/issues/423)) ([cc84d52](https://github.com/halojerry/poundingcore/commit/cc84d523f1014978b0fb9c880842d4fd29330925))
* **assistant:** finalize unified governance storage ([#449](https://github.com/halojerry/poundingcore/issues/449)) ([aba2d2a](https://github.com/halojerry/poundingcore/commit/aba2d2acc0a855152ae372c04b4249e956fc4cbf))
* **auth:** replace newapi-login proxy with sync-credentials endpoint ([3504545](https://github.com/halojerry/poundingcore/commit/350454581fc6e855e30052f829835d77eff2afa0))
* centralize agent runtime session context building ([#419](https://github.com/halojerry/poundingcore/issues/419)) ([b21f833](https://github.com/halojerry/poundingcore/commit/b21f8334e2955c73be4acb2beb76c79133e2120a))
* centralize runtime turn lifecycle ([#421](https://github.com/halojerry/poundingcore/issues/421)) ([282c68c](https://github.com/halojerry/poundingcore/commit/282c68cb43a6c06862ee61c7441a9dd52a3008b7))
* **runtime:** remove legacy Bun runtime support ([#623](https://github.com/halojerry/poundingcore/issues/623)) ([01b5eed](https://github.com/halojerry/poundingcore/commit/01b5eed0db886e05b652c4633c9acd337087e1ab))


### Documentation

* add CLI version audit reference (dual-runtime + pins) ([12f6129](https://github.com/halojerry/poundingcore/commit/12f6129d76e68925e46ff49ed0719d18db084481))
* clarify production logging guidance ([#460](https://github.com/halojerry/poundingcore/issues/460)) ([118ed03](https://github.com/halojerry/poundingcore/commit/118ed03b5393ec87edf8801ed7395d917c87855a))
* de-stale AGENTS.md and guard against symbol-anchored rules ([#649](https://github.com/halojerry/poundingcore/issues/649)) ([9bd188c](https://github.com/halojerry/poundingcore/commit/9bd188cd89990413bc9e70cc9392ac1a1c5fdc91))
* **skills:** add cross-platform notes so Windows users translate shell examples ([#489](https://github.com/halojerry/poundingcore/issues/489)) ([e03b030](https://github.com/halojerry/poundingcore/commit/e03b0309c9fcd4914175d22787efa90e9599c8ec))
